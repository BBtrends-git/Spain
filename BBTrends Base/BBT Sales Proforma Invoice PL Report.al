Report 50998 "Sales - Proforma Invoice PL"
{
    // //INC-2019-01-105854 : Mostrar pie Protección de datos
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/Layouts/Sales - Proforma Invoice PL.rdl';
    ...
    dataset
    {
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            { }
            column(No_SalesHeaderCaption; Text004)
            { }
    ...
    var
        ...
        Text004: label 'Proforma Invoice %1', comment = 'ESP="Factura Proforma %1"';
