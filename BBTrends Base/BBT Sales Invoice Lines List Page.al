Page 50005 "Sales Inv. Lines List"
{
    // //001 IBER AGI 13/06/16 - Page para exportación a Excel de líneas de histórico de facturas
    Caption = 'Sales Inv. Lines';
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    PageType = List;
    ...
    begin
        ...
        if rSalesInvoiceHeader.FindFirst then Divisa := rSalesInvoiceHeader."Currency Code";
    end;
