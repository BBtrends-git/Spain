XmlPort 50033 "Szendex - Shipment XML"
{
    Direction = Export;
    //Encoding = ISO"-";
    Encoding = ISO88592;
    ...
    schema
    {
        textelement(Envelope)
        {
            ...
            textelement(Body)
            {
                ...
                tableelement("Sales Shipment Header";
                "Sales Shipment Header")
                {
                    ...
                    textelement(RecogidaCodigoTipoServicio)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        begin
                            //TODO PDTE VER LOS TIPOS DE SERVICIO
                        end;
                    }
                    textelement(RecogidaGestion)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        begin
                            //TODO PDTE VER LOS TIPOS DE GESTIÓN
                    ...
                    textelement(RecogidaFecha)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        begin
                            //TODO COMENTAR CÓMO TRATAR LA HORA DE RECOGIDA
                    ...
                    textelement(EntregaEmail)
                    {
                        ...
                        begin
                            ...
                            IF "Sales Shipment Header"."Shpfy order No." <> '' THEN EntregaEmail := "Sales Shipment Header"."Sell-to E-mail";
                        end;
                    }
                    ...
                    textelement(EntregaAvisoEmail)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        begin
                            EntregaAvisoEmail := Format(0); //TODO pendiente decidir
                        end;
                    }
                    textelement(EntregaAvisoSms)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        begin
                            EntregaAvisoSms := Format(1); //TODO pendiente decidir
                        end;
                    }
                    ...
                    textelement(Retorno)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        begin
                            //TODO pendiente aclarar y decidir
                            Retorno := Format(0);
                        end;
                    }
                    ...
                    textelement(ImporteValor)
                    {
                        ...
                        trigger OnBeforePassVariable()
                        begin
                            //TODO pendiente aclarar decidir
                    ...
                    tableelement(bultonumero; 50019)
                    {
                    ...
                    tableelement(bultocodigocontenido; 50019)
                    {
                        LinkFields = "Posted Source No." = field("No.");
                        LinkTable = "Sales Shipment Header";
                        NamespacePrefix = 'dir';
                        ...
                        textelement(bultocodigocontenidostring)
                        {
                            ...
                            trigger OnBeforePassVariable()
                            begin
                                //TODO pendiente aclarar
                                BultoCodigoContenidoString := 'PAQ';
                            end;
                        }
                    }
                    tableelement(bultoobservacion; 50019)
                    {
                        LinkFields = "Posted Source No." = field("No.");
                        LinkTable = "Sales Shipment Header";
                        NamespacePrefix = 'dir';
                    ...
                    tableelement(bultoreferencia; 50019)
                    {
                        LinkFields = "Posted Source No." = field("No.");
                        LinkTable = "Sales Shipment Header";
                        NamespacePrefix = 'dir';
    ...
    var
        NewString: Text;
        BaseText: label 'ãõÃÕáàéèíiòóùúÁÀÉÈÍÌÓÒÚÙäëïöüÄËÏÖÜâêîôûÂÊÎÔÛºª'; //'áàéèíiòóùúÁÀÉÈÍÌÓÒÚÙäëïöüÄËÏÖÜºª''çÇ';
        CorrectedText: label 'aoAOaaeeiioouuAAEEIIOOUUaeiouAEIOUaeiouAEIOUoa'; //'aaeeiioouuAAEEIIOOUUaeiouAEIOUoa,cC';
    begin
        Clear(NewString);
