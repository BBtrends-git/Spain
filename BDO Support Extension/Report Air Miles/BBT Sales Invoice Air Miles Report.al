Report 51000 "Sales - Invoice Air Miles"
{
    ...
    // 
    // //17/05/2021 BBT. Corrección. Mostrar Número Albarán.
    DefaultLayout = RDLC;
    RDLCLayout = './src/Report/Layouts/Sales - Invoice Air Miles.rdl';
    Caption = 'Sales - Invoice Air Miles', comment = 'ESP="Ventas - Factura Air Miles"';
    ...
    dataset
    {
        dataitem(CompanyInformation; "Integer")
        {
            ...
            { }
            //column(CostRecicling; CostReciclingTxt)
            //{ }
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            { }
            column(vFooterText1; vFooterText1)
            { }
            column(vFooterText2; vFooterText2)
            { }
            column(vFooterText3; vFooterText3)
            { }
            column(vFooterText4; vFooterText4)
            { }
            ...
            { }
            column(PaymentTermsDescription; vPaymentTermsDescription)
            { }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    { }
                    column(PaymentMethodCode_SalesInvHeader; "Sales Invoice Header"."Payment Method Code")
                    { }
                    ...
                    { }
                    column(WarehouseShipNo; WarehouseShipNo)
                    { }
                    ...
                    { }
                    column(vGCommentCustomer; vGCommentCustomer)
                    { }
                    column(CustomerNoteLbl; CustomerNoteLbl)
                    { }
                    column(CustomerItemRefCaption; CustomerItemRefCaptionLbl)
                    { }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            ItemReference.SetRange("Reference Type No.", "Sales Invoice Header"."Bill-to Customer No.");
                            if ItemReference.FindFirst() then
                                CustomerItemReferenceNo := ItemReference."Reference No."
                            else
                                CustomerItemReferenceNo := '';
                        end;
                    ...
                    dataitem(SalesLineLoop; "Integer")
                    {
                        ...
                        column(CustomerItemReferenceNo_SalesInvLine; CustomerItemReferenceNo)
                        { }
                        ...
                        */
                        //<<
                        column(DiscTotalAmt_SalesInvLine; "Sales Invoice Line"."Line Discount Amount")
                        { }
                        //>> BBT. SMG Extension.
            ...
            var
                ...
                cuScrapCostManagement: Codeunit "Scrap Cost Management";
            begin
                if ("Sales Invoice Header"."Language Code" <> '') and ("Sales Invoice Header"."Language Code" <> 'ESP') then begin
                    ...
                    CurrReport.Language := cLanguage.GetLanguageID("Sales Invoice Header"."Language Code");
                ...
                if "Sales Invoice Header"."Payment Terms Code" = '' then
                    ...
                    vPaymentTermsDescription := PaymentTerms.Description;
                end;
                ...
                Clear(vGCommentCustomer);
                CommentLine.Reset();
                CommentLine.SetCurrentKey(Date);
                CommentLine.Ascending(true);
                CommentLine.SetRange("Table Name", CommentLine."Table Name"::Customer);
                CommentLine.SetRange("No.", "Sales Invoice Header"."Sell-to Customer No.");
                CommentLine.SetRange("Comment type", CommentLine."Comment type"::Invoice);
                CommentLine.SetRange(Desactivado, false);
                if CommentLine.FindLast() then vGCommentCustomer := CommentLine.Comment;
                vVATRegNo := '';
                //>> VAT PL
                Clear(vShowPLCurrencyExchange);
                if rlCustomer.Get("Sales Invoice Header"."Bill-to Customer No.") then
                    if rlCustomer."VAT PL" then begin
                        ...
                        fCheckNBPRates(CalcDate('-1D', "Sales Invoice Header"."Posting Date"), "Sales Invoice Header");
                    end;
                "Sales Invoice Header".CalcFields("Amount Including VAT");
                if rlCurrency.Get("Sales Invoice Header"."Currency Code") then
                    EURLbl := ' ' + rlCurrency.Code
                else
                    EURLbl := ' EUR';
                //>> BBT 22/09/2025. SCRAP Cost
                //CostReciclingTxt := CiaCostReciclingTxt;
                CostReciclingTxt := CostSCRAPtxt + Format(cuScrapCostManagement.InvoiceCalculateScrapCost("Sales Invoice Header"."No.")) + ' €';
                //<<
            end;
        }
    }
    ...
    begin
        ...
        CiaCostReciclingTxt := CompanyInfo."Cost Recicling Text";
        //>> BBT 22/09/2025. Texto SCRAP
        CostSCRAPtxt := 'Contribución  al  SCRAP conforme  a lo establecido  en  el Real' +
                        ' Decreto 1055/2022, de 27 de diciembre ,  destinada a la gestión' +
                        ' y reciclaje de residuos de envases : ';
        //<<
        vFooterText1 := FooterText1;
        vFooterText2 := FooterText2;
        vFooterText3 := CompanyInfo."Commercial Register Text";
        vFooterText4 := CompanyInfo."Texto pie  protecc. de datos 1" + CompanyInfo."Texto pie  protecc. de datos 2" + CompanyInfo."Texto pie  protecc. de datos 3" + CompanyInfo."Texto pie  protecc. de datos 4" + CompanyInfo."Texto pie  protecc. de datos 5";
    ...
    var
        ...
        BankAccNoCaptionLbl: label 'Account No.', comment = 'ESP="Cuenta Corriente"';
        ...
        LOPDtxt: Text;
        CiaCostReciclingTxt: Text;
        CostReciclingTxt: Text;
        CostSCRAPtxt: Text;
        SalesShipmentNoLbl: label 'Sales Shipment No', comment = 'ESP="No. Albarán Venta"';
        ...
        ShipmentMethodLbl: Label 'Shipment Method', comment = 'ESP="Condiciones Envío"';
        CustomerNoteLbl: Label 'Customer note', comment = 'ESP="Nota cliente"';
        vGCommentCustomer: Text[80];
        ...
        CustomerItemReferenceNo: Code[50];
        CustomerItemRefCaptionLbl: Label 'Nº Art. Air Miles';

    procedure fCheckNBPRates(pPostingDate: Date; var pSalesInvHeader: Record "Sales Invoice Header")
    var
    ...
    begin
        ...
        Divisa := pSalesInvHeader."Currency Code";
        ...
        if HttpClient.Get(ApiUrl, HttpResponseMessage) then begin
            if HttpResponseMessage.IsSuccessStatusCode() then begin
                    ...
                    if JsonArray.Count() > 0 then begin
                        ...
                        if JsonToken.IsObject() then begin
                            ...
                            if JsonObject.Get('mid', JsonToken) then begin
                                ...
                                pSalesInvHeader."BBT PL Currency Exchange" := vRate;
                ...
                fCheckNBPRates(CalcDate('-1D', pPostingDate), "Sales Invoice Header");
                //<<
            end;
        end;
    end;
